...
set obsidian to {2200, 3600, 9000}
set midnight to {3500, 5600, 12000}
set panel to {6500, 9000, 12000}
set panel2 to {9000, 11500, 15000}
set accentGold to {43000, 31500, 8500}
set accentBlue to {4200, 16500, 33500}
set accentGreen to {6500, 28500, 13500}
set accentRed to {35500, 7000, 6000}
...
tell application "Numbers"
	...
	tell dash
		set hero to make new table with properties {name:"HeroPanel", row count:3, column count:10, header row count:0, header column count:0}
		...
		set titleTrend to make new table with properties {name:"TitleTrend", row count:2, column count:2, header row count:0, header column count:0}
		...
		set priority to make new table with properties {name:"PriorityPanel", row count:7, column count:2, header row count:0, header column count:0}
	...
	set position of titleTrend to {810, 315}
	set position of titleExpense to {30, 650}
	set position of titleIncome to {540, 650}
	set position of titleDebt to {1050, 650}
	
	set position of coach to {30, 970}
	set position of priority to {1040, 970}
	set position of alerts to {1040, 1235}
	set position of signals to {1040, 1455}
	...
	repeat with c from 1 to 10
		set width of column c of hero to 153
	end repeat
	set height of row 1 of hero to 46
	set height of row 2 of hero to 48
	set height of row 3 of hero to 34
	merge range "A1:E1" of hero
	merge range "A2:E2" of hero
	merge range "F1:J1" of hero
	merge range "F2:J2" of hero
	merge range "A3:B3" of hero
	merge range "C3:D3" of hero
	merge range "E3:F3" of hero
	merge range "G3:H3" of hero
	merge range "I3:J3" of hero
	...
	repeat with titleTable in {titleCash, titleTrend}
	...
	repeat with titleTable in {titleExpense, titleIncome, titleDebt}
		set width of column 1 of titleTable to 230
		set width of column 2 of titleTable to 230
		set height of row 1 of titleTable to 30
		set height of row 2 of titleTable to 24
		merge range "A1:B1" of titleTable
		merge range "A2:B2" of titleTable
	...
	set width of column 3 of coach to 290
	set width of column 4 of coach to 390
	repeat with r from 1 to 6
		set height of row r of coach to 34
	end repeat
	
	set width of column 1 of priority to 170
	set width of column 2 of priority to 330
	set width of column 1 of alerts to 145
	set width of column 2 of alerts to 355
	set width of column 1 of signals to 145
	set width of column 2 of signals to 355
	
	set value of cell "A1" of hero to "BLACKLEDGER ELITE V9"
	set value of cell "A2" of hero to "Signature edition dashboard built to feel premium, modern, and sale-ready."
	set value of cell "F1" of hero to "=AICoach::B2"
	set value of cell "F2" of hero to "=AICoach::C2"
	...
	set value of cell "E3" of hero to "=" & q & "EXPENSE LOAD  " & q & "&ROUND(ExpenseSummary::B10/MAX(1,IncomeSummary::B3)*100,0)&" & q & "%" & q
	set value of cell "G3" of hero to "=" & q & "MONTHS SAVED  " & q & "&MAX(0,DebtSummary::B9)"
	set value of cell "I3" of hero to "=" & q & "FREE CASH  $" & q & "&ROUND(MAX(0,IncomeSummary::B6-ExpenseSummary::B10-DebtSummary::B4),0)"
	...
	set value of cell "A3" of cCash to "=IF(MAX(0,IncomeSummary::B6-ExpenseSummary::B10-DebtSummary::B4)=0," & q & "Tight cushion" & q & "," & q & "Cash remains after debt" & q & ")"
	
	set value of cell "A1" of titleCash to "Cashflow Breakdown"
	set value of cell "A2" of titleCash to "Where collected money goes this month."
	set value of cell "A1" of titleTrend to "Monthly Momentum"
	set value of cell "A2" of titleTrend to "Net cashflow trend from history."
	set value of cell "A1" of titleExpense to "Expense Mix"
	set value of cell "A2" of titleExpense to "Largest categories."
	set value of cell "A1" of titleIncome to "Income Pipeline"
	set value of cell "A2" of titleIncome to "Collected vs pending."
	set value of cell "A1" of titleDebt to "Debt Payoff"
	set value of cell "A2" of titleDebt to "Base vs accelerated."
	...
	set value of cell "B1" of priority to "Where money should move first"
	...
	set value of cell "A3" of priority to "APR"
	set value of cell "B3" of priority to "=INDEX(Debts::C2:C9,MATCH(" & q & "Pay extra here" & q & ",Debts::K2:K9,0))"
	...
	set value of cell "A7" of priority to "Free Cash"
	set value of cell "B7" of priority to "=MAX(0,IncomeSummary::B6-ExpenseSummary::B10-DebtSummary::B4)"
	...
	set format of cell "B3" of priority to percent
	...
	set format of cell "B7" of priority to currency
	
	set background color of range "A1:E1" of hero to obsidian
	set background color of range "A2:E2" of hero to midnight
	set background color of range "F1:J1" of hero to accentGold
	set background color of range "F2:J2" of hero to panel2
	...
	set background color of range "I3:J3" of hero to panel
	set text color of range "A1:J3" of hero to whiteText
	set font size of cell "A1" of hero to 24
	set font size of cell "A2" of hero to 13
	set font size of cell "F1" of hero to 22
	set font size of cell "F2" of hero to 12
	set font size of range "A3:J3" of hero to 12
	set alignment of range "A1:J3" of hero to left
	set text wrap of range "A1:J3" of hero to true
	...
	repeat with titleTable in {titleCash, titleTrend, titleExpense, titleIncome, titleDebt}
		set background color of range "A1:B1" of titleTable to obsidian
	...
	set background color of range "A1:D1" of coach to obsidian
	...
	set background color of range "A2:B7" of priority to panel
	set text color of range "A1:B7" of priority to whiteText
	set font size of range "A1:B7" of priority to 11
	set text wrap of range "A1:B7" of priority to true
	...
	set format of range "B2:B6" of probeTrend to currency
