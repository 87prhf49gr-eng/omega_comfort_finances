...
# Puerto libre (8765–8775, luego 8080 / 8888)
pick_port() {
...
# IP “principal” (interfaz de la ruta por defecto — suele ser la Wi‑Fi real)
primary_ip() {
  local IF
...
# Todas las IPv4 útiles (sin loopback ni link-local)
all_lan_ips() {
