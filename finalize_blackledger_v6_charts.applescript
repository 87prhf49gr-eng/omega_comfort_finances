...
tell application "Numbers"
	...
	try
		delete sheet "DupTest" of theDoc
	end try
	...
	repeat with tableName in {"CashflowProbe", "IncomeProbe", "DebtProbe", "LiveChartCashflow", "LiveChartIncome", "LiveChartDebt"}
		try
	...
	return "Charts=" & (count charts of dash) & linefeed & "ActiveSheet=" & name of active sheet of theDoc
end tell
